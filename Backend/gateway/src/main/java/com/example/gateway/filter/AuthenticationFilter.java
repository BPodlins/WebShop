...
public class AuthenticationFilter extends AbstractGatewayFilterFactory<AuthenticationFilter.Config> {
    ...
    public GatewayFilter apply(Config config) {
        return ((exchange, chain) -> {
            ...
            if (validator.isSecure.test((org.springframework.http.server.reactive.ServerHttpRequest) exchange.getRequest())) {
                if (!exchange.getRequest().getCookies().containsKey(HttpHeaders.AUTHORIZATION) && !exchange.getRequest().getCookies().containsKey("refresh")) {
                    ...
                    StringBuilder stringBuilder = new StringBuilder("{\n")
                            ...
                            .append("\",\n")
                            .append("\"message\": \"This token is invalid\",\n")
                            .append("\"code\": \"A3\"\n")
                            .append("}");
                ...
                try {
                    ...
                    log.warn("Can't login invalid token");
