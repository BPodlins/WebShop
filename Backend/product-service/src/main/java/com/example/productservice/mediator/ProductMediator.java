...
public class ProductMediator {
    ...
    public ResponseEntity<Response> saveProduct(ProductFormDTO productFormDTO) {
        try{
            ...
            return ResponseEntity.ok(new Response("Successfully created a product"));
        }catch (RuntimeException e){
            e.printStackTrace();
            return ResponseEntity.status(400).body(new Response("Can't create product, category does not exist"));
        }
    ...
    public ResponseEntity<Response> deleteProduct(String uuid) {
        try{
            ...
            return ResponseEntity.status(400).body(new Response("Product does not exist"));
        }
